...
contract SimpleBank {
    ...
    function deposit() public payable returns (uint) {
      // 1. Add the appropriate keyword so that this function can receive ether - OK
    
      // 2. Users should be enrolled before they can make deposits
      require(enrolled[msg.sender] = true, "You mustbe enrolled before sending a deposit");
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
      ...
      require( withdrawAmount <= balances[msg.sender], "You can only withdraw funds less than or equal to those you have deposited" );
     ...
     // wallet.transfer(withdrawAmount);
